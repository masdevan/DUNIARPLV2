    ...
    <div class="content">
        ...
        <div class="row items-push">
            <div class="col-md-6 col-xl-4">
                <!-- Story #13 -->
                <a class="block block-rounded bg-image d-flex flex-column h-100 mb-0"
                    style="background-image: url('assets/media/photos/photo29.jpg');" href="javascript:void(0)">
            ...
            <div class="col-md-6 col-xl-4">
                <!-- Story #14 -->
                <a class="block block-rounded bg-image d-flex flex-column h-100 mb-0"
                    style="background-image: url('assets/media/photos/photo17.jpg');" href="javascript:void(0)">
                    <div class="block-content bg-black-50 flex-grow-1">
                        <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                            <p>
            ...
            <div class="col-md-6 col-xl-4">
                <!-- Story #15 -->
                <a class="block block-rounded bg-image d-flex flex-column h-100 mb-0"
                    style="background-image: url('assets/media/photos/photo34.jpg');" href="javascript:void(0)">
                    <div class="block-content bg-black-50 flex-grow-1">
                        <div class="d-sm-flex justify-content-sm-between align-items-sm-center">
                            <p>
