                ...
                <div class="container pt-10 pb-19 pt-md-14 pb-md-20 text-center">
                    <div class="row">
                        <div class="col-md-7 col-lg-6 col-xl-5 mx-auto">
                            ...
                            <p class="lead px-lg-5 px-xxl-8">Selamat datang di jurnal blog kami. Disini kami membagikan
                                informasi teknologi terkini.</p>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
                                        ...
                                        <div class="card-body">
                                            <div class="post-header">
                                                ...
                                                <h2 class="post-title mt-1 mb-0"><a class="link-dark"
                                                        href="./blog-post.html">Amet Dolor Bibendum Parturient
                                                        Cursus</a></h2>
                                            </div>
                                            <!-- /.post-header -->
                                            <div class="post-content">
                                                <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget
                                                    ...
                                                    condimentum nibh. Cras mattis consectetur purus sit amet fermentum.
